...
public class cAnexos {
    ...
    public cAnexos(int id, String doc, int aut, Date vencto, Date recto, BigDecimal valor, Date dataHora, String logado, String lanctos) {
        Id = new SimpleIntegerProperty(id);
        Doc = new SimpleStringProperty(doc);
