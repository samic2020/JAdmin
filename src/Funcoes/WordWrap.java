...
public class WordWrap implements java.io.Serializable {
    ...
    interface WordWrapScanner
    {
        ...
        int scan(StringBuffer buf, int startIndex, double nextLoc);
    }

    static class CharColumnScanner implements WordWrapScanner {
    ...
    static class FontMetricsScanner implements WordWrapScanner {
        FontMetrics metrics;
