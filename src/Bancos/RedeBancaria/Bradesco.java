...
public class Bradesco {
    ...
    public Bradesco(DadosBanco Banco) {
...
/*
        ...
        String valor3 = this.dadosBanco.getBanco_Agencia() + this.dadosBanco.getBanco_Conta() + this.dadosBanco.getBanco_Carteira() + valor1;
        String valor2 = CalcDig10(valor3);
        return valor1 + valor2;
*/
        String valor1 = this.dadosBanco.getBanco_Carteira() + StringManager.Right(FuncoesGlobais.StrZero("0", 11) +
                value,11);
...
/*
        ...
        strcodbar = this.dadosBanco.getBanco() + this.dadosBanco.getBanco_CodMoeda() +
                FatorVencimento(vencimento) + Valor4Boleta(valor) +
                this.dadosBanco.getBanco_Carteira() + nossonumero + this.dadosBanco.getBanco_Agencia() +
                this.dadosBanco.getBanco_Conta() + this.dadosBanco.getBanco_ContaDv() + "000";
        dv3 = CalcDig11(strcodbar,9,0);
        return this.dadosBanco.getBanco() + this.dadosBanco.getBanco_CodMoeda() + dv3 +
                FatorVencimento(vencimento) + Valor4Boleta(valor) + this.dadosBanco.getBanco_Carteira() + nossonumero +
                this.dadosBanco.getBanco_Agencia() + this.dadosBanco.getBanco_Conta() + this.dadosBanco.getBanco_ContaDv() + "000";
*/
